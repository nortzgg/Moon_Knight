...
namespace NinjutsuGames.StateMachine.Runtime
{
    public static class GraphUtils
    {
        ...
        static TraversalGraph ConvertGraphToTraversalGraph(StateMachineAsset graph)
        {
        ...
        public static List<BaseNode> DepthFirstSort(StateMachineAsset g)
        {
        ...
        public static void FindCyclesInGraph(StateMachineAsset g, Action<BaseNode> cyclicNode)
        {
            var graph = ConvertGraphToTraversalGraph(g);
