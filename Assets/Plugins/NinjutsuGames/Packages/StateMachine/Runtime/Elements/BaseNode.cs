...
namespace NinjutsuGames.StateMachine.Runtime
{
    ...
    public abstract class BaseNode
    {
        ...
        protected int NodeId(GameObject nodeContext) => !nodeContext ? -1 : nodeContext.GetInstanceID() + GUID.GetHashCode();
        ...
        public bool CanExecute(GameObject currentContext)
        {
             var runner = currentContext.Get<StateMachineRunner>();
             var isRunnerEnabled = runner == null || runner.enabled;
             var contextDisabled = currentContext && (IsContextDisabled.Contains(NodeId(currentContext)) || !currentContext.activeInHierarchy);
             return enabledForExecution && !contextDisabled && isRunnerEnabled;
        }
        ...
        public void OnProcess(Args customArgs)
        {
        ...
        /// </summary>
        protected virtual void Process(Args customArgs)
        {
        }
