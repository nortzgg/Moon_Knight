...
namespace NinjutsuGames.StateMachine.Editor
{
    ...
    public class RunnerVariableListTool : TPolymorphicListTool
    {
        ...
        public StateMachineAsset StateMachineAsset => (StateMachineAsset) m_Property.FindPropertyRelative("m_Node").FindPropertyRelative("m_StateMachine").objectReferenceValue;
        
        // CONSTRUCTOR: ---------------------------------------------------------------------------

        public RunnerVariableListTool(SerializedProperty property)
        ...
        {
            return new RunnerVariableItemTool(this, index);
        }
        ...
        protected override void SetupFoot()
        {
            ...
            m_ButtonAdd = new Button(() =>
            {
                ...
                InsertItem(insertIndex, new RunnerVariableItem(this.m_Property.FindPropertyRelative("m_Node").FindPropertyRelative("m_StateMachine").objectReferenceValue as StateMachineAsset));
            })
            {
            ...
            m_ButtonAdd.Add(new Label { text = "Add Variable..." });
