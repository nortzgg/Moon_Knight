...
{
    public class TraverseSequenceTool : SequenceTool
    {
        private const string USS_PATH = EditorPaths.PACKAGES + "Traversal/Editor/StyleSheets/TraverseSequence";
        ...
        private const string NAME_CONTROL_PREVIEW = "GC-Traversal-Traverse-Sequence-Preview";

        private const string CLASS_PREVIEW = "gc-traversal-traverse-sequence-preview-on";
        ...
        public TraverseSequenceTool(SerializedProperty property) : base(property)
        {
        ...
        protected override TrackTool CreateTrackTool(int trackIndex)
        {
            ...
            if (track.managedReferenceValue.GetType() == typeof(TrackTraverseMotionWarpingPosition))
            {
                return new TrackToolTraverseMotionWarpingPosition(this, trackIndex);
            }
            
            if (track.managedReferenceValue.GetType() == typeof(TrackTraverseMotionWarpingRotation))
            {
                return new TrackToolTraverseMotionWarpingRotation(this, trackIndex);
            }
            
            if (track.managedReferenceValue.GetType() == typeof(TrackTraverseGravity))
            {
                return new TrackToolTraverseGravity(this, trackIndex);
            }
