...
{
    public class TrackToolTraverseMotionWarpingPosition : TrackTool
    {
        // CONSTRUCTOR: ---------------------------------------------------------------------------
        
        public TrackToolTraverseMotionWarpingPosition(SequenceTool sequenceTool, int trackIndex) 
        ...
        {
            clip.SetValue(new ClipTraverseMotionWarpingPosition());
