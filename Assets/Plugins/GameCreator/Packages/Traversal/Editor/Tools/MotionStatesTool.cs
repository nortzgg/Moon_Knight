...
{
    public class MotionStatesTool : TPolymorphicListTool
    {
        private static readonly IIcon ICON_ADD = new IconCharacterState(ColorTheme.Type.TextLight);
        
        private const string NAME_BUTTON_ADD = "GC-MotionStates-Foot-Add";
        ...
        protected override string ElementNameHead => "GC-MotionStates-Head";
        protected override string ElementNameBody => "GC-MotionStates-Body";
        protected override string ElementNameFoot => "GC-MotionStates-Foot";

        protected override List<string> CustomStyleSheetPaths => new List<string>
        {
            EditorPaths.PACKAGES + "Traversal/Editor/StyleSheets/MotionStates"
        };
        ...
        public MotionStatesTool(SerializedProperty property) : base(property, "m_States")
        {
        ...
        {
            return new MotionStateTool(this, index);
        }
        ...
        protected override void SetupFoot()
        {
            ...
            this.m_ButtonAdd.Add(new Label { text = "Add State..." });
