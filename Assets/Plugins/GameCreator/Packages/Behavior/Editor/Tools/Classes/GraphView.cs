...
namespace GameCreator.Editor.Behavior
{
    internal class GraphView : VisualElement
    {
        ...
        {
            get => this.m_Content.resolvedStyle.translate;
            set
            {
                this.m_Content.style.translate = value;
        ...
        public float Scale
        {
            get => this.m_Content.resolvedStyle.scale.value.x;
            set
            {
                ...
                this.m_Content.style.scale = scale;
        ...
        public Matrix4x4 ContentMatrix => Matrix4x4.TRS(
            this.m_Content.resolvedStyle.translate,
            Quaternion.Euler(0f, 0f, this.m_Content.resolvedStyle.rotate.angle.ToDegrees()),
            this.m_Content.resolvedStyle.scale.value
        );
