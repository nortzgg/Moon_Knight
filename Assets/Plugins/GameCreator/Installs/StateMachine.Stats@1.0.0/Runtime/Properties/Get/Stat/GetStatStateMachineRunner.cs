...
namespace NinjutsuGames.StateMachine.Runtime.Stats
{
    ...
    [Description("Returns the Stat value of a State Machine Runner Variable")]

    [Serializable] [HideLabelsInEditor]
    public class GetStatStateMachineRunner : PropertyTypeGetStat
    {
        [SerializeField]
        protected FieldGetStateMachineRunner m_Variable = new FieldGetStateMachineRunner(ValueStat.TYPE_ID);
