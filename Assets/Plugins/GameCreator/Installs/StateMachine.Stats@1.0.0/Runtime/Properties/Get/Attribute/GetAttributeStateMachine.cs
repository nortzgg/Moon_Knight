...
namespace NinjutsuGames.StateMachine.Runtime.Stats
{
    ...
    [Description("Returns the Attribute value of a State Machine Variable")]

    [Serializable] [HideLabelsInEditor]
    public class GetAttributeStateMachine : PropertyTypeGetAttribute
    {
        [SerializeField]
        protected FieldGetStateMachine m_Variable = new FieldGetStateMachine(ValueAttribute.TYPE_ID);
