...
namespace NinjutsuGames.StateMachine.Runtime.Inventory
{
    ...
    public class SetRuntimeItemStateMachine : PropertyTypeSetRuntimeItem
    {
        [SerializeField]
        protected FieldSetStateMachine m_Variable = new(ValueItem.TYPE_ID);
        ...
        public static PropertySetRuntimeItem Create => new PropertySetRuntimeItem(
            new SetRuntimeItemStateMachine()
        );
